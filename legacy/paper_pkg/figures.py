...
def main():
    ...
    order = ["Reactive_MyopicGreedy","Lookahead_Greedy","ShootingSearch_DeltaNode","Predicted_DAG_NetworkX","Sustainable_DAG_NetworkX","Learned_TC_Offline","Learned_TC_RTCorrected"]
